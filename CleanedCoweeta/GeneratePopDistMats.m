function [BoundaryDeathSetCoords,NonBoundarySetCoords,BirthsSetCoords,NonBirthBoundarySetCoords,...
...
AllBirthCountMat=zeros(size(landGrid));
AllMaxCountMat=zeros(size(landGrid));
AllDeathCountMat=zeros(size(landGrid));
ReproBirthCountMat=zeros(size(landGrid));
ReproMaxCountMat=zeros(size(landGrid));
ReproDeathCountMat=zeros(size(landGrid));
NonBirthCountMat=zeros(size(landGrid));
NonMaxCountMat=zeros(size(landGrid));
NonDeathCountMat=zeros(size(landGrid));
