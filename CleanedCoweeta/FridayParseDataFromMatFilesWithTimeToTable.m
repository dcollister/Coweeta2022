function []=parseDataFromMatFilesWithTimeToTable(mainDirContents,this_folder,maxPositions,runCount)
...
%                             Seed=ComparisonObject.s;
                            ...
                            writetable(fileInfo,[mainDirContents(runCount).folder '\Fileinfo_' this_folder '.csv'])
